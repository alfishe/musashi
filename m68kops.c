...
static void m68k_op_jsr_32_ai(void)
{
	...
	/* Silicon parity: 68000/010 check the target address for alignment
	 * AFTER jumping but BEFORE pushing the return address. If odd, trap
	 * immediately. The return address remains NOT pushed, resulting in a
	 * 14-byte exception frame at the original SSP. */
	m68ki_check_pc_address_error_010_less();

	m68ki_trace_t0();				   /* auto-disable (see m68kcpu.h) */
	m68ki_push_32(old_pc);
}
...
static void m68k_op_muls_16_d(void)
{
	...
	if(CPU_TYPE_IS_010_LESS(CPU_TYPE)) {
		...
		if (f && !(x & 0x80000000)) c += 2; /* final transition for positive multipliers */
		USE_CYCLES(c);
	}
...
/*   function                      mask    match    000  010  020  040 */
	...
	{m68k_op_addq_16_a           , 0xf1f8, 0x5048, {  8,   4,   2,   2,   2}},
	...
	{m68k_op_addq_32_a           , 0xf1f8, 0x5088, {  6,   8,   2,   2,   2}},
	...
	{m68k_op_subq_32_a           , 0xf1f8, 0x5188, {  6,   8,   2,   2,   2}},
	...
	{m68k_op_btst_8_r_i          , 0xf1ff, 0x013c, { 10,   8,   6,   6,   6}},
	...
	{m68k_op_bclr_32_s_d         , 0xfff8, 0x0880, { 12,  14,   4,   4,   4}},
	...
	{m68k_op_tas_8_ai            , 0xfff8, 0x4ad0, { 14,  14,  16,  16,  16}},
	{m68k_op_tas_8_pi            , 0xfff8, 0x4ad8, { 14,  14,  16,  16,  16}},
	{m68k_op_tas_8_pd            , 0xfff8, 0x4ae0, { 16,  16,  17,  17,  17}},
	{m68k_op_tas_8_di            , 0xfff8, 0x4ae8, { 18,  18,  17,  17,  17}},
	{m68k_op_tas_8_ix            , 0xfff8, 0x4af0, { 20,  20,  19,  19,  19}},
	...
	{m68k_op_tas_8_pi7           , 0xffff, 0x4adf, { 14,  14,  16,  16,  16}},
	{m68k_op_tas_8_pd7           , 0xffff, 0x4ae7, { 16,  16,  17,  17,  17}},
	{m68k_op_tas_8_aw            , 0xffff, 0x4af8, { 18,  18,  16,  16,  16}},
	{m68k_op_tas_8_al            , 0xffff, 0x4af9, { 22,  22,  16,  16,  16}},
